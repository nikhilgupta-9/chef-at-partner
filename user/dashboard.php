...
$verify_stmt = $conn->prepare("SELECT email_verified FROM users WHERE id = ?");
$verify_stmt->bind_param("i", $_SESSION['user_id']);
$verify_stmt->execute();
$isVerified = $verify_stmt->get_result()->fetch_assoc();

if ($isVerified['email_verified'] != 1) {
                    ...
                    <div class="col-md-4">
                        <div class="stats-card bookings">
                            <h3>
                                ...
                                $pending_stmt = $conn->prepare("SELECT COUNT(*) FROM bookings WHERE customer_id = ? ");
