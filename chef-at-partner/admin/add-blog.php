                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select name="status" class="form-control select2" required>
                                                        <option value="draft" <?= (isset($_POST['status']) && $_POST['status'] == 'draft') ? 'selected' : '' ?>>Draft
                                                        </option>
                                                        <option value="published" <?= (!isset($_POST['status']) || (isset($_POST['status']) && $_POST['status'] == 'published') ? 'selected' : '') ?>>Published</option>
                                                        <option value="archived" <?= (isset($_POST['status']) && $_POST['status'] == 'archived') ? 'selected' : '' ?>>Archived
                                                        </option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" name="image" class="form-control" required
                                                        accept="image/*">
                                                    <small class="text-muted">Max size: 5MB (JPG, PNG, WEBP,
                                                        GIF)</small>
                                                    <div class="mt-2">
