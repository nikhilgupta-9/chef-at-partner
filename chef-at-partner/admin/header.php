...
<nav class="sidebar vertical-scroll dark_sidebar ps-container ps-theme-default ps-active-y">
    ...
    <ul id="sidebar_menu" class="sidebar-menu mt-3">
        ...
        <li><a href="partners.php"><i class="fas fa-user" style="color: #7d22e6;"></i> <span>All
                    Partners</span></a>
        </li>
        ...
        <li>
            ...
            <ul>
                <li><a href="manage-services.php">Add Service</a></li>
                <li><a href="view-testimonials.php">View Services</a></li>
            </ul>
        </li>

        <li>
            <a class="has-arrow" href="#"><i class="fas fa-fire" style="color: #ff6b6b;"></i><span>Special
                    Offers</span></a>
            <ul>
        ...
        <li><a href="add-gallery.php"><i class="fas fa-images" style="color: #8e44ad;"></i> <span>Gallery</span></a>
        </li>
        ...
        <li><a href="auth/logout.php"><i class="fas fa-sign-out-alt" style="color: #e74c3c;"></i> <span>Log
                    Out</span></a></li>
    </ul>
</nav>
