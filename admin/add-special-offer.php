                                ...
                                <form action="" method="post" enctype="multipart/form-data" class="mb-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" name="offer_title" id="offer_title" required
                                                class="form-control"><br>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Offer Description:</label>
                                            <textarea name="offer_description" id="offer_description" required
                                                class="form-control"></textarea><br>
                                        </div>
                                        <div class="col-md-6">
                                            <label>Offer Image:</label> <small class="text-danger">** image must be
                                                750px X 300px</small>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <button class="btn btn-warning btn-sm"
                                                        onclick="editOffer(<?= $row['id']; ?>, '<?= $row['title']; ?>', '<?= $row['description']; ?>', '<?= $row['status']; ?>')">Edit</button>
