                        ...
                        <table class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Cusotmers ID</th>
                                    <th scope="col">Mobile</th>
                                    <th scope="col">Email</th>
                                    <th scope="col">Product Order</th>
                                    <th scope="col text-center">Billing Details</th>
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td class=""><a href="edit_products.php?edit_product_details=<?= $row['id'] ?>"><i
                                                    class="fa-regular fa-pen-to-square text-primary fs-3"></i></a></td>
                                        <form action="" method="post">
                                            <td class=""><a href="product_delete.php?delete=<?= $row['id'] ?>"><i
