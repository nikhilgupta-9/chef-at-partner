...
<head>
    ...
    <style>
        ...
        .verified-badge { background-color: #d1ecf1; color: #0c5460; }
        .pending-badge { background-color: #fff3cd; color: #856404; }
        ...
        <div class="main_content_iner ">
            <div class="container-fluid p-0 sm_padding_15px">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="stat-card">
                            <div class="stat-number"><?php echo number_format($stats['avg_rating'] ?? 0, 1); ?> <i class="fas fa-star text-warning"></i></div>
                    ...
                    <div class="col-xl-2 col-md-4 col-sm-6">
                        <div class="stat-card">
                            <div class="stat-number">₹<?php echo number_format($stats['total_hourly_rate'] ?? 0, 0); ?></div>
                            ...
                            <form method="GET" class="row g-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="type" class="form-select">
                                        ...
                                        <?php endwhile; mysqli_data_seek($types_result, 0); ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="search" class="form-control" placeholder="Search by name, email, phone or Aadhar" value="<?php echo $search; ?>">
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="table-avatar">
                                                        ...
                                                        <div>
                                                            ...
                                                            <small class="text-muted">Aadhar: <?php echo $partner['aadhar_number']; ?></small>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if (!empty($partner['aadhar_back'])): ?>
                                                        <i class="fas fa-id-card document-icon" 
                                                           title="View Aadhar Back" 
                                                           onclick="window.open('<?php echo $partner['aadhar_back']; ?>')"></i>
                                                    <?php endif; ?>
                                                </td>
                                                <td class="table-skills" title="<?php echo implode(', ', array_slice($skills, 0, 5)); ?>">
                                                    <?php if (!empty($skills)): ?>
                                                ...
                                                <td>
                                                    <?php if ($partner['is_verified']): ?>
                                                        ...
                                                        <?php if (!empty($partner['verified_at'])): ?>
                                                            <br>
                                                            <small class="text-muted"><?php echo date('d M Y', strtotime($partner['verified_at'])); ?></small>
                                                        <?php endif; ?>
                                                    <?php else: ?>
                                                ...
                                                <td><?php echo date('d M Y', strtotime($partner['user_created'])); ?></td>
                                                <td class="table-actions">
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu action-dropdown">
                                                            <li>
                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#viewPartnerModal<?php echo $partner['id']; ?>">
                                                                    <i class="fas fa-eye me-2"></i>View Details
                                                                </a>
                                                            </li>
                                                            <?php if (!$partner['is_verified']): ?>
                                                            <li>
                                                                <a class="dropdown-item text-success" href="partners.php?action=verify&id=<?php echo $partner['id']; ?>" 
                                                            ...
                                                            <?php else: ?>
                                                            <li>
                                                                <a class="dropdown-item text-warning" href="partners.php?action=unverify&id=<?php echo $partner['id']; ?>" 
                                                            ...
                                                            <?php if ($partner['user_status'] == 'active'): ?>
                                                            <li>
                                                                <a class="dropdown-item text-warning" href="partners.php?action=deactivate&id=<?php echo $partner['id']; ?>" 
                                                            ...
                                                            <?php else: ?>
                                                            <li>
                                                                <a class="dropdown-item text-success" href="partners.php?action=activate&id=<?php echo $partner['id']; ?>" 
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editPartnerModal<?php echo $partner['id']; ?>">
                                                            ...
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="partners.php?action=delete&id=<?php echo $partner['id']; ?>" 
                                            ...
                                            <!-- View Partner Modal -->
                                            <div class="modal fade" id="viewPartnerModal<?php echo $partner['id']; ?>" tabindex="-1">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title">Partner Details - <?php echo $partner['full_name']; ?></h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-md-4 text-center">
                                                                    ...
                                                                    <p class="text-muted"><?php echo ucfirst($partner['partner_type']); ?> Partner</p>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            <p><strong>Email:</strong><br><?php echo $partner['email']; ?></p>
                                                                            <p><strong>Phone:</strong><br><?php echo $partner['phone']; ?></p>
                                                                            <p><strong>Aadhar Number:</strong><br><?php echo $partner['aadhar_number']; ?></p>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <p><strong>Experience:</strong><br><?php echo $partner['experience_years']; ?> years</p>
                                                                            <p><strong>Hourly Rate:</strong><br>₹<?php echo number_format($partner['hourly_rate'], 2); ?></p>
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="d-flex">
                                                                                <?php if (!empty($partner['aadhar_front'])): ?>
                                                                                <div class="me-3">
                                                                                    <p class="mb-1"><small>Aadhar Front</small></p>
                                                                                ...
                                                                                <?php if (!empty($partner['aadhar_back'])): ?>
                                                                                <div>
                                                                                    <p class="mb-1"><small>Aadhar Back</small></p>
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        <div class="col-12">
                                                                            <div class="alert alert-success">
                                                                                <strong><i class="fas fa-check-circle me-1"></i> Verified</strong><br>
                                                                                <small>
                                                                                    Verified by: <?php echo $partner['verified_by'] ?? 'Admin'; ?><br>
                                                                                    Verified on: <?php echo date('d M Y H:i', strtotime($partner['verified_at'])); ?>
                                                                                </small>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <!-- Edit Partner Modal -->
                                            <div class="modal fade" id="editPartnerModal<?php echo $partner['id']; ?>" tabindex="-1">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="number" name="hourly_rate" class="form-control" 
                                                                           value="<?php echo $partner['hourly_rate']; ?>" step="0.01" min="0" required>
                                                                </div>
                                                                
                                                                <div class="mb-3">
                                                                    <label class="form-label">Experience (Years)</label>
                                                                    <input type="number" name="experience_years" class="form-control" 
                                                                           value="<?php echo $partner['experience_years']; ?>" min="0" max="50" required>
                                                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mt-3">
                                        <div>
                                            <small class="text-muted">Showing <?php echo mysqli_num_rows($result); ?> partners</small>
                                        </div>
                                        <div>
                                            <nav>
